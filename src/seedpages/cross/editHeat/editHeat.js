/**
 * Created by ranyanchuan on 2017/12/29.
 */
/**
...
@Auth
class EiditHeat extends React.Component {
  state = {
    current: 1,
    queryOne: '',
    queryTwo: '',
  ...
  componentWillMount() {
    ...
    const { id,domain1,domain2 } = this.props.match.params;
...
export default connect(({ app, loading, crossHeat }) => ({ app, loading, crossHeat }))(EiditHeat);
