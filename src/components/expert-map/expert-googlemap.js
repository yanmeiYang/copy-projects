          ...
          <div className={styles.right}>
            <div className={styles.legend}>
              ...
              <div className={styles.container}>
                ...
                <div className={styles.item1}><FM id="com.expertMap.explanation.legend.small"
                                                  defaultMessage="少" />
                </div>
                <div className={styles.item2}> 2</div>
                <div className={styles.item3}> 3</div>
                <div className={styles.item4}> 4</div>
                <div className={styles.item5}><FM id="com.expertMap.explanation.legend.large"
                                                  defaultMessage="多" />
                </div>
              </div>
            </div>
