...
class ExpertTrajectory extends React.Component {
  ...
  componentDidMount() {
    // loadScript('http://api.map.baidu.com/api?v=2.0&ak=iMmdUvS0a3GlqkvFiyxrjomo4XpjkZSz', () => {
  ...
  showChart = () => { // 功能起始函数
    ...
    option = {
      ...
      series: [{
        ...
        label: { normal: { show: true, position: 'right', formatter: '{b}' }, emphasis: { show: true } },
        symbolSize: 6,
        itemStyle: { normal: { color: '#fff', borderColor: 'gold' } },
        data: [{
          name: '59f8ba5017c44a765858bc74',
          value: [123,20],
        }, {
          name: '59f8ba5017c44a765858c054',
          value: [114,33],
        }, {
          name: '59f8ba5117c44a765858c1ee',
          value: [118, 32],
        }, {
          name: '59f8ba5117c44a765858cad9',
          value: [40, 116],
        }],
      }, {
        type: 'lines',
        ...
        lineStyle: { normal: { color: '#f78e3d', width: 1.5, opacity: 0.4, curveness: 0.2 } },
        data: [],
      }],
    };
