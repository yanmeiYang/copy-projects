...
export default {
  ...
  effects: {
    ...
    * addExpertToEB({ payload }, { call, put }) {
    ...
    // * getPersonIsExistInEB({ payload }, { call, put }){
    //   const { data } = yield call(expertBaseService.getPersonIsExistInEB, { payload },
    //   );
    // },
    ...
    * getExpertBaseList({ payload }, { call, put }) {
      const data = yield call(expertBaseService.getExpertList);
      yield put({ type: 'getExpertBaseListSuccess', payload: { data } });
    },
  },
