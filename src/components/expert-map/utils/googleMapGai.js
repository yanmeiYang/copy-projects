...
function GetGoogleMapLib(showTop) {
  return function showOverLay() {
    ...
    (function () {
       ...
       * @private
       */
      MarkerClusterer.prototype.MARKER_CLUSTER_IMAGE_PATH_ = `${resRoot}/images/map/m`;
      ...
      function Cluster(markerClusterer) {
        ...
        //this.clusterMarker_ = new BMapLib.TextIconOverlay(this._center, this._markers.length, { styles: this._markerClusterer.getStyles() });
...
export default GetGoogleMapLib;
